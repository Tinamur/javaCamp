...
package mernisClient;

public class KPSPublicLocator extends org.apache.axis.client.Service implements mernisClient.KPSPublic {
    ...
    public mernisClient.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public mernisClient.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mernisClient.KPSPublicSoapStub _stub = new mernisClient.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mernisClient.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                mernisClient.KPSPublicSoapStub _stub = new mernisClient.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
