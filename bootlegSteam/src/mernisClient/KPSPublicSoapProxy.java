...
public class KPSPublicSoapProxy implements mernisClient.KPSPublicSoap {
  private String _endpoint = null;
  private mernisClient.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new mernisClient.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public mernisClient.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
